...
$stmt = $conn->prepare("SELECT date, level FROM progress WHERE user_key = ? ORDER BY date DESC");
if (!$stmt) {
...
$pdf->MultiCell(0, 5, 'Bu rapor Fit40+ uygulaması tarafından otomatik olarak oluşturulmuştur. Daha fazla bilgi için uygulamamızı ziyaret edin: https://www.fit40plus.com', 0, 'L');
